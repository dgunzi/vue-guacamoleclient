...
/**
 * 提供guacClientManager服务使用的ManagedClient类。
 * @param template
 * @constructor
 */

let ManagedClientState = function ManagedClientState(template) {
...
ManagedClientState.setConnectionState = function(clientState, connectionState, statusCode) {
    ...
    if (clientState.connectionState === ManagedClientState.ConnectionState.TUNNEL_ERROR ||
        clientState.connectionState === ManagedClientState.ConnectionState.CLIENT_ERROR) { return; }
...
export default ManagedClientState;